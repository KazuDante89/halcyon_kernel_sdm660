...
git clone --depth=1 https://github.com/KazuDante89/nebula_kernel_sdm660 -b nebula kernel
cd kernel
...
function zipping() {
    cd AnyKernel || exit 1
    zip -r9 [EAS]-Nebula-Kernel_v0.0.0.zip *
    cd ..
}
sendinfo
compile
